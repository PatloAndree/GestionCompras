		...
		<div class="card-body">
			...
			<div class="card">
				<div class="card-body border-bottom text-right">
					<button class="btn btn-info" tabindex="0" type="button" data-bs-toggle="modal" id="añadirCategoria"><span>Añadir categoria</span></button>
				</div>
				<div class="card-datatable table-responsive pt-0">
					<table class="user-list-table table" id="tabla_productos">
						<thead class="table-light">
						<tr>
							<th class="text-left whitespace-no-wrap">CATEGORIA</th>
							<th class="whitespace-no-wrap">UNIDAD DE MEDIDA</th>
		...
		<div class="modal-dialog modal-lg modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body pb-5 px-sm-5 pt-50">
					...
					<form id="nuevaCategoriaForm" name="nuevaCategoriaForm" class="row gy-1 pt-75">
						<div class="col-md-12">
						...
						<div class="col-md-12">
							<label class="form-label" for="unidad_nombreE">Unidades</label>
				...
				<div class="modal-footer">
					<div class="col-12 text-right mt-2 pt-50 form-botones">
						<button type="button" id="nuevaCategoriaCrear" class="btn btn-info me-1">Guardar</button>
		...
		<div class="modal-dialog modal-lg modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body pb-5 px-sm-5 pt-50">
					...
					<form id="editarCategoriaForm" name="editarCategoriaForm" class="row gy-1 pt-75">
						<input type="text" id="categoriaId" class="hidden">
						...
						<div class="col-12 text-right mt-2 pt-50 form-botones">
							<button type="button" id="editarCategoria" class="btn btn-info me-1">Editar</button>
							<button type="reset" class="btn btn-outline-danger" data-bs-dismiss="modal" aria-label="Close">Cancelar</button>
						</div>
					</form>
				</div>
